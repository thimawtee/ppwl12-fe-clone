...
const Hero: React.FC = () => {
  ...
  `}</style>
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[100%] h-[550px] pointer-events-none"
        style={{
          background: "radial-gradient(ellipse at 50% 0%, rgba(180,190,255,0.6) 0%, rgba(100,120,220,0.2) 50%, transparent 70%)",
      ...
      <svg className="absolute right-0 top-[-5%] pointer-events-none z-10" style={{ width: "30%", height: "90%" }} viewBox="0 0 960 900" fill="none">
        <path d="M959.69 156H74.82a70.4 70.4 0 0 0-17.04 138.72l357.76 89.21a86.04 86.04 0 0 1-8.19 168.59l-225.23 33.42a50.95 50.95 0 1 0 15.24 100.74l252.22-38.87C581.18 627.53 678.3 514.3 678.3 381.13V73.82a69.37 69.37 0 0 0-138.74 0v55.58c0 69.01 55.94 124.96 124.96 124.96h266.8"
          stroke="url(#gradRight)" strokeWidth="10" fill="none" strokeLinecap="round" />
        <defs>
      ...
      {/* Floating Icons Kiri - mengikuti kurva */}
      <div className="absolute left-[12%] top-[18%] z-20 text-3xl">📖</div>
      <div className="absolute left-[3%] top-[28%] z-20 text-2xl">✅</div>
      <div className="absolute left-[2%] top-[48%] z-20 text-2xl">📬</div>
      <div className="absolute left-[10%] top-[60%] z-20 flex gap-2 text-2xl">
        <span>📧</span>
        <span>🟠</span>
      </div>

      {/* Floating Icons Kanan - mengikuti kurva */}
      <div className="absolute right-[10%] top-[18%] z-20 flex gap-1 text-2xl">
        <span>🐙</span>
        <span>☑️</span>
      </div>
      <div className="absolute right-[1%] top-[42%] z-20 text-2xl">💡</div>
      <div className="absolute right-[5%] top-[58%] z-20 flex gap-2 text-2xl">
        <span>💬</span>
        <span>💡</span>
      </div>
      ...
      {/* Workspace Video Mockup — full width, di luar Container */}
      <div className="relative z-20 w-full px-6 md:px-20 lg:px-32 max-w-[1200px] mx-auto">
            ...
            >
              <div className="bg-black/50 rounded-md p-1.5">
                {paused ? (
                  ...
                  <svg width="16" height="16" viewBox="0 0 32 32" fill="none">
                    <rect x="8" y="6" width="5" height="20" rx="1.5" fill="white" />
                    <rect x="19" y="6" width="5" height="20" rx="1.5" fill="white" />
                  </svg>
                )}
              </div>
            </div>
